...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        SELECT
          ...
          /* ───── Snapshot del ÚLTIMO case_flow ACTIVO (por caso, MAX(id)) ───── */
          ...
          sch_last.inspection_cancelled AS schedule_inspection_cancelled,
          ...
          /* Solo el ÚLTIMO case_flow ACTIVO como JSON objeto */
        ...
        /* ─────────── ÚLTIMO case_flow ACTIVO por caso ─────────── */
        LEFT JOIN (
          SELECT cf1.*
        ...
        /* ─────────── JSON SOLO del último case_flow ACTIVO ─────────── */
        LEFT JOIN (
          SELECT
            cf1.obi_case_id,
            JSON_OBJECT(
        ...
        /* ─────────── ÚLTIMA programación vigente por caso ─────────── */
        LEFT JOIN (
          SELECT
            s1.case_id,
            s1.message_sent,
